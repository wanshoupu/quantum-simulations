...
def allprop(a: NDArray, b: NDArray, rtol=1.e-5, atol=1.e-8, equal_nan=False) -> PropCheck:
    """
...
def id_prop(a: NDArray, rtol=1.e-5, atol=1.e-8, equal_nan=False) -> PropCheck:
    """
...
def unitary_prop(a: NDArray, rtol=1.e-5, atol=1.e-8, equal_nan=False) -> PropCheck:
    """
